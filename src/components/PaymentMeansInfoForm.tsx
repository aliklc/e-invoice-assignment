...
export function PaymentMeansInfoForm() {
 ...
 return (
    <section className="space-y-4">
        ...
        <h2 className="text-red-600 text-2xl font-semibold">Ödeme Bilgileri</h2>
        <FormField
          control={control}
        ...
        <div className="col-span-5 grid grid-cols-2 gap-4">
          ...
          <div className="col-span-5 grid grid-cols-2 gap-4 mt-4">
            ...
            <div className="col-span-5 grid grid-cols-2 gap-4 mt-4">
                <h2 className="text-red-600 text-xl font-semibold">SGK Bilgileri</h2>
            </div>
            <div className="col-span-5 grid grid-cols-3 gap-4">
            <FormField
            control={control}
            ...
            <div className="col-span-5 grid grid-cols-2 gap-4 mt-4">
                <h2 className="text-red-600 text-xl font-semibold">Gider Bilgileri</h2>
            </div>
            <div className="col-span-5 grid grid-cols-3 gap-4">
            <FormField
            control={control}
            name="EInvoice.InvoiceInfo.Expenses.0.ExpenseType"
            render={({ field }) => (
                <FormItem className="space-y-2">
            ...
            <FormField
                control={control}
                name="EInvoice.InvoiceInfo.Expenses.0.Percent"
                render={({ field }) => (
                <FormItem className="space-y-2">
            ...
            <FormField
                control={control}
                name="EInvoice.InvoiceInfo.Expenses.0.Amount"
                render={({ field }) => (
                <FormItem className="space-y-2">
